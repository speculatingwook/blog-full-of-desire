    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="hidden xl:sticky xl:top-0 max-h-screen h-full sm:flex flex-wrap bg-gray-50 dark:bg-gray-900/70 shadow-md pt-5 dark:shadow-gray-800/40 rounded min-w-[280px] max-w-[280px] overflow-auto">
